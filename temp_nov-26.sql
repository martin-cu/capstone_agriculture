...
CREATE TABLE `diagnosis` (
  ...
  `value` tinytext,
  `pd_id` int NOT NULL,
  `diagnosis_status` enum('Present','Solved') NOT NULL DEFAULT 'Present',
...
INSERT INTO `diagnosis` VALUES (1,'Pest','2021-10-10',1,'100',1,'Present'),(2,'Disease','2021-10-10',1,'110',2,'Present');
...
INSERT INTO `farm_materials` VALUES (1,1,1,'Seed',500,1,'grams'),(2,1,2,'Seed',220,1,'grams'),(3,1,3,'Fertilizer',390,1,'grams'),(4,1,1,'Pesticide',200,1,'grams');
...
CREATE TABLE `fertilizer_disease` (
  `fertilizer_disease_id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `pesticide_table` VALUES (1,'Pesticide11','for bugs'),(2,'Pesticide2','for worms'),(3,'PestIdIde','New pesticide desc'),(5,'PestIdIde3','New pesticide desc'),(6,'Jotdag','Jotdag descriptionnnnnnnnnnnn');
...
CREATE TABLE `purchase_table` (
  ...
  KEY `farm_id_idx` (`farm_id`),
  CONSTRAINT `farm_idConnect` FOREIGN KEY (`farm_id`) REFERENCES `farm_table` (`farm_id`),
...
INSERT INTO `purchase_table` VALUES (1,1,'Seed','This is item',200,'2021-10-10 00:00:00',50,'Kg','Pending',1,'2020-10-10',1),(2,2,'Seed','This is seed 2',150,'2021-10-11 00:00:00',50,'Kg','Purchased',1,'2020-10-10',1),(3,1,'Fertilizer','This is new item',250,'2020-10-10 00:00:00',60,'sacks','Processing',1,'2020-10-10',1),(4,2,'Fertilizer','This is fertilizer',200,'2021-10-10 00:00:00',77,'sacks','Pending',1,'2020-10-10',1),(6,3,'Seed',NULL,NULL,NULL,100,'Kg','Pending',1,'2021-11-25',2),(7,5,'Pesticide',NULL,NULL,NULL,90,'Kg','Pending',1,'2021-11-25',2),(8,2,'Seed',NULL,NULL,NULL,2,'Kg','Pending',1,'2021-11-25',2),(9,2,'Fertilizer',NULL,NULL,NULL,90,'Kg','Pending',1,'2021-11-25',35),(10,1,'Seed',NULL,NULL,NULL,12,'Kg','Pending',1,'2021-11-25',35);
...
INSERT INTO `seed_table` VALUES (1,'Dinarada','dinorado desc',90,NULL),(2,'168','168 desc',120,NULL),(3,'Seedling','New seedling desc',20,NULL),(4,'s','s',NULL,NULL);
...
INSERT INTO `sessions` VALUES ('H3JUgXh5hyNdOG-4PXu3f0DqcnhOrXmp',1637960411,'{\"cookie\":{\"originalMaxAge\":108000000,\"expires\":\"2021-11-25T18:27:57.990Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}'),('TykS-Tv9Gwe2Av5RQo-MrIvNUsMbl6sB',1638015681,'{\"cookie\":{\"originalMaxAge\":108000000,\"expires\":\"2021-11-27T12:06:42.320Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}');
...
-- Dump completed on 2021-11-26 14:29:13
